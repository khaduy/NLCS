...
<?php
    ...
    ?> <div class='form-text main-content uedit'>
        ...
        ?>
            <div class="form-text main-content uedit">
                <h4 style="text-align: center;">Thêm nhân viên thành công</h4>
                <a href=user_listing.php >Danh sách</a>
            </div>
        <?php
        } else {
        ?>
            <div class="form-text main-content uedit">
                <h4 style="text-align: center;">Có lỗi xảy ra trong quá trình đăng ký</h4>
                <a href='javascript: history.go(-1)'>Trở lại</a>
            </div>
        <?php }
    } else {
        ...
        <div class="form-text main-content uedit">
            ...
            <form action="?action=insertP" method="POST" enctype="multipart/form-data">
                <label>Chức vụ:</label> <br><input type="text" name="username" size="30"><br><br>
                <label>Tên nhân viên:</label> <br><input type="text" name="fullname" size="30"><br><br>
